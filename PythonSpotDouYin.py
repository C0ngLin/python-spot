...
all = html.xpath('//*[@id="node-221"]/div/div[2]/div[1]/a')
print(all)
paiming = 1
...
for item in all:
    ...
    print(create_time)
    print("==========================================")
    sql = """INSERT INTO spot_douyin(spot_douyin_title,spot_douyin_url, spot_douyin_port,
     spot_douyin_zhishu,spot_douyin_create_time)
             VALUES (%s,%s,%s,%s,%s)"""
