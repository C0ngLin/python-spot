...
all = html.xpath('//*[@id="node-54"]/div/div[2]/div[1]/a')
print(all)
paiming = 1
...
for item in all:
    ...
    print(create_time)
    print("==========================================")
    sql = """INSERT INTO spot_sleep(spot_sleep_title,spot_sleep_url, spot_sleep_port,
     spot_sleep_zhishu,spot_sleep_create_time)
             VALUES (%s,%s,%s,%s,%s)"""
    val = (title, finalurl, paiming-1, 0, create_time)
    try:
        # 执行sql语句
