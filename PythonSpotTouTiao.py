...
all = html.xpath('//*[@id="node-46"]/div/div[2]/div[1]/a')
print(all)
paiming = 1
...
for item in all:
    ...
    print("==========================================")
    sql = """INSERT INTO spot_toutiao(spot_toutiao_title,spot_toutiao_url, spot_toutiao_port,
     spot_toutiao_zhishu,spot_toutiao_create_time)
             VALUES (%s,%s,%s,%s,%s)"""
